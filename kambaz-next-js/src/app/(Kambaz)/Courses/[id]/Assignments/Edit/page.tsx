    ...
    <div className="container mt-4" style={{ maxWidth: 640 }}>
      ...
      <form>
        <div className="mb-3">
          ...
          <input type="text" id="assignmentName" className="form-control"
            value={name} onChange={e => setName(e.target.value)} />
        </div>
        <div className="mb-3">
          <label htmlFor="assignmentDescription" className="form-label">Description</label>
          <textarea id="assignmentDescription" className="form-control"
            value={description} onChange={e => setDescription(e.target.value)} />
        </div>
        <div className="mb-3">
          <label htmlFor="assignmentPoints" className="form-label">Points</label>
          <input type="number" id="assignmentPoints" className="form-control"
            value={points} onChange={e => setPoints(Number(e.target.value))} min={0} />
        </div>
        <div className="row mb-3">
          <div className="col">
            <label htmlFor="assignmentDueDate" className="form-label">Due Date</label>
            <input type="date" id="assignmentDueDate" className="form-control"
              value={dueDate} onChange={e => setDueDate(e.target.value)} />
          </div>
          <div className="col">
            <label htmlFor="assignmentAvailableFrom" className="form-label">Available From</label>
            <input type="date" id="assignmentAvailableFrom" className="form-control"
          ...
          <div className="col">
            ...
            <input type="date" id="assignmentUntilDate" className="form-control"
        ...
        <div className="mb-3">
          ...
          <input type="text" id="assignmentAssignTo" className="form-control"
